														...
														<td class="text-center">
															<jstl:choose>
																<jstl:when test="${chefData.key.status eq 'Blocked'}">
																	<a type="button" href="/admin/viewChefAction?id=${chefData.key.id}&action=Active" class="btn btn-outline-info">Active</a>
																</jstl:when>
																<jstl:otherwise>
																	<a type="button" href="/admin/viewChefAction?id=${chefData.key.id}&action=Blocked" class="btn btn-outline-primary">Block</a>
																</jstl:otherwise>
															</jstl:choose>
														</td>
													</tr>
