...
<title>Homion Admin - Add Area</title>
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<form:form action="insertArea" method="post" modelAttribute="Area">
										<fieldset>
											<div class="form-group">
												<label for="cname">Area Name
													</label> <form:input id="cname" class="form-control"
													name="name" minlength="2" type="text" path="name" required="required"/>
											</div>
											
											<div class="form-group">
												<label for="ccomment">Pincode</label>
												<form:input type="number" id="ccomment" class="form-control" name="comment"
												 path="pincode" required="required"/>
											</div>
